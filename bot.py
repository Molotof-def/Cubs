...
MOTIVATIONAL_QUOTES: List[str] = [
    ...
    "💪 <i>«Серия неудач — это лишь разбег перед крупным триумфом. Главное — сохранять холодный рассудок.»</i>",
    "🛡 <i>«Опыт строится на ошибках. Кубики переменчивы, но мастерство распределения банка остаётся!»</i>",
    "⚡ <i>«Фортуна благоволит терпеливым. Удача обязательно вернется в следующем раунде!»</i>",
    "🧠 <i>«Не поддавайся тильту! Поставь правильную цель, обуздай эмоции и забери куш.»</i>"
]
FUNNY_SUPPORT_QUOTES: List[str] = [
    # --- 50 СМЕШНЫХ И АБСУРДНЫХ ПОДДЕРЖЕК ---
    ...
    "🧘 <b>СЛОВА ПОДДЕРЖКИ:</b> <i>Сделай глубокий вдох... медленный выдох... и спрячь руки в карманы подальше от клавиатуры.</i>",
    "☕ <b>СЛОВА ПОДДЕРЖКИ:</b> <i>Поставь чайник. Чай хотя бы согреет, а кубик тебя только что раздел до нитки.</i>",
    "🛑 <b>СЛОВА ПОДДЕРЖКИ:</b> <i>Баланс на нуле, зато совесть чиста. Иди напиши ворк, шахтёр виртуальный!</i>",
    "🎯 <b>СЛОВА ПОДДЕРЖКИ:</b> <i>Фортуна просто моргнула. Ну или отвернулась и ушла пить пиво без тебя.</i>",
    ...
    "🧠 <b>СЛОВА ПОДДЕРЖКИ:</b> <i>Мозг просил остановиться ещё три ставки назад. Но пальцы жили своей жизнью!</i>",
    "💸 <b>СЛОВА ПОДДЕРЖКИ:</b> <i>Твои монеты ушли на благотворительность в фонд поддержки серверных стоек бота.</i>",
    "🧯 <b>СЛОВА ПОДДЕРЖКИ:</b> <i>Срочно вызывайте пожарных, тут у кого-то кресло догорает после броска на смерть!</i>",
    "🚿 <b>СЛОВА ПОДДЕРЖКИ:</b> <i>Сходи умойся холодной водой. Может, морок лудомании отпустит!</i>",
    "🛌 <b>СЛОВА ПОДДЕРЖКИ:</b> <i>Ложись спать. Во сне хотя бы баланс не минусуется.</i>",
    ...
    "🍫 <b>СЛОВА ПОДДЕРЖКИ:</b> <i>Съешь шоколадку для выработки эндорфинов, а то на твоё лицо сейчас без слёз не взглянешь.</i>",
    "🎩 <b>СЛОВА ПОДДЕРЖКИ:</b> <i>И фокус удался: монеты были тут — и исчезли! Аплодисменты магу!</i>",
    "🛸 <b>СЛОВА ПОДДЕРЖКИ:</b> <i>Твою ставку только что похитили инопланетяне для опытов над человеческой наивностью.</i>",
    "📚 <b>СЛОВА ПОДДЕРЖКИ:</b> <i>Самое время почитать книжку. Про экономику и финансовую грамотность, желательно с картинками.</i>",
    ...
    "🧱 <b>СЛОВА ПОДДЕРЖКИ:</b> <i>Удача встретилась со стеной реальности. Реальность победила нокаутом в первом раунде.</i>",
    "🪞 <b>СЛОВА ПОДДЕРЖКИ:</b> <i>Посмотри в зеркало и скажи: «Я больше не буду ставить вабанк». И соври себе ещё раз!</i>",
    "🛴 <b>СЛОВА ПОДДЕРЖКИ:</b> <i>Пешком ходить полезно для здоровья. Особенно когда проиграл на автобус.</i>",
    ...
    "🪁 <b>СЛОВА ПОДДЕРЖКИ:</b> <i>Твои фишки улетели, как воздушный змей на штормовом ветру. Красиво, но грустно.</i>",
    "🧸 <b>СЛОВА ПОДДЕРЖКИ:</b> <i>Обними плюшевого мишку. Он хотя бы не заберёт у тебя последние 500 монет.</i>",
    "🎣 <b>СЛОВА ПОДДЕРЖКИ:</b> <i>Казино поймало тебя на крючок азарта. Срывайся и плыви на ворк!</i>",
    "🧦 <b>СЛОВА ПОДДЕРЖКИ:</b> <i>Главное, что носки целые. Одежду в казино пока не принимают.</i>",
    ...
    "🧩 <b>СЛОВА ПОДДЕРЖКИ:</b> <i>Пазл не сложился, кубик подвёл, бот злодей. Стандартное оправдание засчитано!</i>",
    "🍿 <b>СЛОВА ПОДДЕРЖКИ:</b> <i>Чат запасся попкорном и с удовольствием наблюдал за твоим эпичным сливом.</i>",
    "🪗 <b>СЛОВА ПОДДЕРЖКИ:</b> <i>Эх, гармонь играй, пропадай баланс! Гуляем на все... а, всё уже кончилось.</i>",
    "🚦 <b>СЛОВА ПОДДЕРЖКИ:</b> <i>Красный свет горит для твоих ставок! Стой на месте 12 часов!</i>",
    "🎈 <b>СЛОВА ПОДДЕРЖКИ:</b> <i>Пфффф... Это лопнул твой банкролл. Зато какой был звук!</i>",
    "🧃 <b>СЛОВА ПОДДЕРЖКИ:</b> <i>Выпей сока, успокойся. Завтра вернешься на ворк как новенький.</i>",
    "🪙 <b>СЛОВА ПОДДЕРЖКИ:</b> <i>Если монета упала ребром — это к удаче. Но она упала в карман дилера.</i>",
    "⛺ <b>СЛОВА ПОДДЕРЖКИ:</b> <i>Ставь палатку у команды /work. Это теперь твой основной дом на ближайшие дни.</i>",
    "🔭 <b>СЛОВА ПОДДЕРЖКИ:</b> <i>В телескоп видно твой профит: он находится в другой галактике.</i>",
    ...
    "🧮 <b>СЛОВА ПОДДЕРЖКИ:</b> <i>Счёты показывают: дебит с кредитом подрались, победил ноль.</i>",
    "🎪 <b>СЛОВА ПОДДЕРЖКИ:</b> <i>Цирк уехал, а главный номер с исчезновением банка только что закончился!</i>",
    "🎖 <b>СЛОВА ПОДДЕРЖКИ:</b> <i>Медаль за отвагу перед лицом гарантированного проигрыша отправляется тебе!</i>",

    # --- 50 ВАРИАНТОВ С ЛЁГКИМ БУЛЛИНГОМ И ПОДКОЛАМИ ---
    ...
    "💀 <b>СЛОВА ПОДДЕРЖКИ:</b> <i>Если бы за глупые ставки давали награды, ты бы уже возглавлял список Forbes.</i>",
    "🍼 <b>СЛОВА ПОДДЕРЖКИ:</b> <i>Малыш расстроился? Иди поплачь в подушку или попроси у мамы монетку на обед.</i>",
    "🦥 <b>СЛОВА ПОДДЕРЖКИ:</b> <i>Даже ленивец нажимает кнопки с большим умом, чем ты ставишь вабанки.</i>",
    ...
    "🤏 <b>СЛОВА ПОДДЕРЖКИ:</b> <i>Шанс выиграть был огромен, но твоя криворукость превзошла все законы теории вероятностей.</i>",
    "🐒 <b>СЛОВА ПОДДЕРЖКИ:</b> <i>Если посадить обезьяну за клавиатуру, она сольёт банкролл медленнее, чем ты.</i>",
    "🤡 <b>СЛОВА ПОДДЕРЖКИ:</b> <i>Смотрите все: человек добровольно отдал боту всё до копейки и теперь ждёт сочувствия!</i>",
    "📉 <b>СЛОВА ПОДДЕРЖКИ:</b> <i>Твой баланс худеет быстрее, чем люди на самых жестких диетах. Поздравляю!</i>",
    "🤦‍♂️ <b>СЛОВА ПОДДЕРЖКИ:</b> <i>Рука-лицо. Вот всё, что можно сказать про твою последнюю игру. Не позорься больше!</i>",
    "🧂 <b>СЛОВА ПОДДЕРЖКИ:</b> <i>Осторожно, чат! Тут разлилось море солёных слёз очередного неудачника на кубах!</i>",
    "🦀 <b>СЛОВА ПОДДЕРЖКИ:</b> <i>Клешни вместо рук мешают вовремя нажать кнопку «Стоп»? Сочувствуем, ракообразный!</i>",
    "💸 <b>СЛОВА ПОДДЕРЖКИ:</b> <i>Спасибо за донат в казну бота! Бот на твои деньги купит себе новое виртуальное пиво.</i>",
    "🎪 <b>СЛОВА ПОДДЕРЖКИ:</b> <i>Клоунский нос упал, подними. Сколько раз повторять: лудомания тебя не кормит!</i>",
    "🧊 <b>СЛОВА ПОДДЕРЖКИ:</b> <i>IQ стремительно падает с каждым новым нажатием команды 'кубик'. Остановись, пока не поздно!</i>",
    "🥚 <b>СЛОВА ПОДДЕРЖКИ:</b> <i>Твой банкролл пуст, как скорлупа от пасхального яйца. Иди фарми ворк, трудяга!</i>",
    "🦆 <b>СЛОВА ПОДДЕРЖКИ:</b> <i>Кря-кря! Утка и то поняла бы, что на рулетке смерти шанс сгореть — 33%. А ты полез!</i>",
    "🕳 <b>СЛОВА ПОДДЕРЖКИ:</b> <i>Чёрная дыра завидует скорости, с которой твои сбережения исчезают в никуда.</i>",
    "🐌 <b>СЛОВА ПОДДЕРЖКИ:</b> <i>Твой прогресс в казино двигается назад со скоростью реактивной улитки.</i>",
    "💩 <b>СЛОВА ПОДДЕРЖКИ:</b> <i>Сыграно отвратительно, ставка бездарная, результат закономерный. Зато стабильность!</i>",
    "🎣 <b>СЛОВА ПОДДЕРЖКИ:</b> <i>Карась клюнул на наживку! Бот поймал тебя на глупый азарт как первоклассника.</i>",
    "🔨 <b>СЛОВА ПОДДЕРЖКИ:</b> <i>Тебе надо гвозди забивать, а не стратегию ставок строить. Хотя молоток ты тоже сломаешь.</i>",
    "🚫 <b>СЛОВА ПОДДЕРЖКИ:</b> <i>Вход в казино тебе противопоказан медицинским консилиумом чата. Сиди смирно!</i>",
    "📉 <b>СЛОВА ПОДДЕРЖКИ:</b> <i>График твоих побед напоминает пике падающего кирпича. Никаких отскоков!</i>",
    "🥶 <b>СЛОВА ПОДДЕРЖКИ:</b> <i>Как там на морозе без штанов? Нормально дует? В следующий раз думай головой!</i>",
    "🥱 <b>СЛОВА ПОДДЕРЖКИ:</b> <i>Твои проигрыши уже даже не удивляют. Скучно, банально, предсказуемо слит!</i>",
    "🦴 <b>СЛОВА ПОДДЕРЖКИ:</b> <i>Грызи кость и жди зарплату с ворка. На большее твой банкролл сегодня не тянет.</i>",
    "🎭 <b>СЛОВА ПОДДЕРЖКИ:</b> <i>Оскар за самую бездарно проигранную ставку года безоговорочно достается тебе!</i>",
    "🙈 <b>СЛОВА ПОДДЕРЖКИ:</b> <i>Я закрою глаза, чтобы не видеть этого позора. Как можно было ТАК слить?</i>",
    "🛸 <b>СЛОВА ПОДДЕРЖКИ:</b> <i>Даже пришельцы с Марса в шоке от твоей финансовой политики. Учись считать!</i>",
    "🚷 <b>СЛОВА ПОДДЕРЖКИ:</b> <i>Осторожно: зона повышенной глупости! Игрок только что оставил здесь всё имущество.</i>",
    "🧻 <b>СЛОВА ПОДДЕРЖКИ:</b> <i>Держи салфетку, утри сопли и не ной в чате. Сам нажал на кнопку — сам страдай!</i>",
    "🪓 <b>СЛОВА ПОДДЕРЖКИ:</b> <i>Рубил с плеча, а отрубил себе весь депозит под корень. Лесоруб комнатный!</i>",
    "🦥 <b>СЛОВА ПОДДЕРЖКИ:</b> <i>Интуиция уровня «хлебушек». Если думаешь ставить — ставь наоборот, целее будешь!</i>",
    "🍼 <b>СЛОВА ПОДДЕРЖКИ:</b> <i>Может, тебе выдать погремушку вместо кубиков? Безопаснее для баланса будет.</i>",
    "🎪 <b>СЛОВА ПОДДЕРЖКИ:</b> <i>Арена пуста, клоун остался без гроша. Занавес! Иди спать, шоу окончено.</i>",
    "📉 <b>СЛОВА ПОДДЕРЖКИ:</b> <i>Твой баланс пробил дно и начал копать нефть. Поздравляю с новым рекордом нищеты!</i>",
    "🧐 <b>СЛОВА ПОДДЕРЖКИ:</b> <i>Я долго изучал твою тактику игры и пришёл к выводу: тактики не было, был чистый идиотизм.</i>",
    "🗿 <b>СЛОВА ПОДДЕРЖКИ:</b> <i>Каменное лицо при полном нуле на счету. Уверенность в завтрашнем дне так и прёт!</i>",
    "🪤 <b>СЛОВА ПОДДЕРЖКИ:</b> <i>Сыр был вкусный? Мышеловка захлопнулась, монеты тю-тю. Приятного аппетита!</i>",
    "🩼 <b>СЛОВА ПОДДЕРЖКИ:</b> <i>Твоей финансовой подушке безопасности срочно нужны костыли и реанимация.</i>",
    "🦧 <b>СЛОВА ПОДДЕРЖКИ:</b> <i>Нажимать одну кнопку научился, а считать вероятности — нет. Эволюция дала сбой!</i>",
    "💣 <b>СЛОВА ПОДДЕРЖКИ:</b> <i>Бабах! Это взорвалась твоя последняя надежда уйти сегодня в плюс. Помянем!</i>",
    "🛶 <b>СЛОВА ПОДДЕРЖКИ:</b> <i>Уплыл без вёсел в сторону берега банкротов. Счастливого плавания!</i>",
    "🕳 <b>СЛОВА ПОДДЕРЖКИ:</b> <i>Если ты искал дно — поздравляю, ты его нашёл и уверенно в него постучал снизу.</i>",
    "🧯 <b>СЛОВА ПОДДЕРЖКИ:</b> <i>Огнетушитель не поможет, когда в голове пожар азарта, а в кармане сквозняк.</i>",
    "🪞 <b>СЛОВА ПОДДЕРЖКИ:</b> <i>Посмотри на себя. Опять бот забрал твои монетки? И кто в этом виноват?</i>",
    "🛑 <b>СЛОВА ПОДДЕРЖКИ:</b> <i>Хватит позориться на весь чат! Закрой бота и займись уроками или работой!</i>"
]
WORK_TASKS: List[str] = [
...
async def force_quiz_cmd(message: Message):
    """Принудительный запуск викторины (только Главный разработчик и Создатели)."""
    user_id = message.from_user.id
    ...
    text = (
        f"⚡️ <b>ВНЕОЧЕРЕДНАЯ ИНТЕЛЛЕКТУАЛЬНАЯ ВИКТОРИНА!</b>\n"
        f"<i>(Вызвана администратором проекта)</i>\n"
        f"━━━━━━━━━━━━━━━━━━━━\n"
        f"❓ <b>Вопрос:</b> {quiz_item['q']}\n\n"
        f"💰 Награда первому верному ответу: <b>+{fmt_num(reward)} 💰</b> на баланс!\n"
        f"💡 <i>Просто напишите правильный ответ прямо в чат сообщением!</i>\n"
        f"━━━━━━━━━━━━━━━━━━━━"
    )
    await safe_reply(message, text)
